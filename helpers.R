...
api.func<-function(x){
  rcon<-redcapConnection(url="https://urldefense.proofpoint.com/v2/url?u=https-3A__informatics.ctrsu.org_redcap-5Fv6.13.1_API_&d=AwIGAg&c=SgMrq23dbjbGX6e0ZsSHgEZX6A4IAf1SO3AJ2bNrHlk&r=wcbmyDqDWuqu1tbAMmr8cBwjMxQ8KchflUxEHuV0DjQ&m=pIb9p2aEUxZfXZPXSwIA43DbvxcC1R-pr5cJUo9dZUQ&s=8kI8TuZgMoXsFYWkRxFGGEN-bfTOgPMT8cJ51dvcwvA&e= ",token=x)
